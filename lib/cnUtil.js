...
function CnUtil() {
    ...
    this.sign_message = function(key, message, pubkey) {
        ...
        //return this.check_signature(pubkey, message_hash, sig_c(0), sig_r(0));
    ...
    //WIP
    this.check_signature = function(pub_key, message_hash, signature) {

        var sig_size = STRUCT_SIZES.SIGNATURE * 1;
        let sig_decoded = hextobin(cnBase58.decode(signature));
        var sig_m = Module._malloc(sig_size);
